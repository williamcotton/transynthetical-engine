...
export const trivia: Problem[] = [
  {
    ...
    operation: "Quiz Country Capital",
  },
  {
  ...
  },
  {
    ...
    answer: "1939",
    grade_level: "1st grade, 2nd grade",
    category: "Pop Culture Research",
    operation: "Quiz Year",
  },
  {
    question: "What year did Superman first appear in comics?",
    answer: "1938",
    grade_level: "1st grade, 2nd grade",
    category: "Pop Culture Research",
    operation: "Quiz Year",
  ...
  {
    question: "What year did Spiderman first appear in comics?",
    answer: "1962",
    grade_level: "1st grade, 2nd grade",
    category: "Pop Culture Research",
    operation: "Quiz Year",
  ...
  {
    question: "What's the main industry in Austevoll, Norway?",
    answer: "Fishing",
    grade_level: "1st grade, 2nd grade",
    category: "Geography Research",
    operation: "Quiz Industry",
  },
  {
    question: "What is the reverse of the name of the mayor of Chicago?",
    answer: "toofthgiL iroL",
    grade_level: "1st grade, 2nd grade",
    category: "Geography Research and Strings",
    operation: "Quiz City Mayor and Reverse",
  },
  {
  ...
  {
    question:
      "What is the population of Geneseo, NY combined with the population of Rochester, NY?",
    answer: 218902,
    grade_level: "1st grade, 2nd grade",
    category: "Geography Research and Addition",
    operation: "Quiz City Population and Addition",
  },
  {
    question:
  ...
  {
    question:
      "What is the rot13 of the answer to the question 'What is the capital of France?'?",
    answer: "Cnevf",
    grade_level: "1st grade, 2nd grade",
    category: "Geography and Computation",
    operation: "Quiz Country Capital and Computation",
  },
];

export const rot13: Problem[] = [
  {
    question: "What's the rot13 of 'Hello World'?",
    answer: "Uryyb Jbeyq",
    grade_level: "1st grade, 2nd grade",
    category: "Computation",
    operation: "Basic Rot13",
  },
  {
    question: "What's the rot13 of 'I love you'?",
    answer: "V ybir lbh",
    grade_level: "1st grade, 2nd grade",
    category: "Compuation",
    operation: "Basic Rot13",
...
export const fibonacci: Problem[] = [
  {
    question:
      "If 1 is the 1st number, what's the 10th number in the Fibonacci sequence?",
    answer: 55,
    grade_level: "1st grade, 2nd grade",
    category: "Computation",
  ...
  {
    question:
      "If 1 is the 1st number, what's the 20th number in the Fibonacci sequence?",
    answer: 6765,
    grade_level: "1st grade, 2nd grade",
    category: "Computation",
  ...
  {
    question:
      "If 1 is the 1st number, what's the 30th number in the Fibonacci sequence?",
    answer: 832040,
    grade_level: "1st grade, 2nd grade",
    category: "Computation",
...
export const strings: Problem[] = [
  {
    question: "What's the reverse of 'Hello World'?",
    answer: "dlroW olleH",
    grade_level: "1st grade, 2nd grade",
    category: "Strings",
    operation: 10,
  ...
  {
    question: "What's the reverse of 'I love you'?",
    answer: "uoy evol I",
    grade_level: "1st grade, 2nd grade",
    category: "Strings",
    operation: 20,
...
export const subtraction: Problem[] = [
  {
    question:
  ...
  {
    question:
      "The hobby store normally sells 10,576,241 trading cards per month. In July, the hobby store sold a total of 23,223,152 trading cards. How many more trading cards did the hobby store sell in July compared with a normal month?",
    answer: 12646911,
    grade_level: "1st grade, 2nd grade",
    category: "Subtraction",
    operation: "Over 10,000,000",
  },
];

export const decimals: Problem[] = [
  {
    question:
...
export const ratiosAndPercentages: Problem[] = [
  {
    question:
...
export const probabilityDataRelationships: Problem[] = [
  {
    question:
  ...
  {
    question:
      "The faces on a fair number die are labelled 1, 2, 3, 4, 5 and 6. You roll the die 12 times. How many times should you expect to roll a 1?",
    answer: 2,
    grade_level: "4th grade, 5th grade, 6th grade, 7th grade",
    category: "Probability and Data Relationships",
...
export const multiplication: Problem[] = [
  {
    question:
...
export const openEnded: Problem[] = [
  {
  ...
  {
    question:
      "What kind of journal is the The New England Journal of Medicine?",
    answer: "medical journal",
    grade_level: "University",
    category: "Academic Literature",
    operation: "Quiz Academic Literature",
  },
  {
  ...
  {
    question:
      "Answering as [rowInt, colInt], writing and archiving custom predictBestMove, getEmptySpaces, minimax and checkWinner functions implemented in the thunk, what is the best tic-tac-toe move for player X on this board: [['X', '_', 'X'], ['_', '_', '_'], ['O', '_', 'O']]?",
    answer: [0, 1],
    grade_level: "University",
